...
void setup(){
    ...
    itemsAlmacen.push_back(new Item("Inutil", "Recibo de Compras: 'Harina, Tomates, Cebollas, Huevo, Leche...'", 1));

    itemsCocina.push_back(new Item("Arma", "Cuchilo: Se ve que es de alta calidad, está muy filoso", 3));
